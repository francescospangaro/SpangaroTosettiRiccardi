...
create and manage tournaments and it lets them grant permission
...
\item \textbf{Account Manager}
    ...
    \begin{itemize}
        ...
        \item \textbf{invite(senderId, receiverIds):} This method takes the inviter Student's ID and an array of the invited Students' IDs, checks if
        each ID corresponds to a Student's ID saved in the platform and, if so, sends each invited Student a notification, notifying them of the invitation they just received.
    \end{itemize}
\end{itemize}
