...
\begin{itemize}
    ...
    \item[\textbf{D16:}] An Educator can insert in a battle a test or automated script.
...
% Check from here
    \item[\textbf{5.}] \textbf{Educator delete a badge}
          \begin{xltabular}{\textwidth}
              ...
              \textbf{Exceptions} &    \begin{itemize}
                  ...
                  \item[4.2] The new image uploaded as icon, it is too big or have an unsupported format.
                  \item[4.3] New Badge's rules are not well defined.
                  \item[4.4] Some badge's features has been left empty
                        \begin{itemize}
                            \item[$\rightarrow$] Badge it is not updated, Educator is led to
    ...
    \item[\textbf{8.}] \textbf{Educator evaluate battle's results}
          \begin{xltabular}{\textwidth}
              ...
              within a tournament, that has terminated. Educator want to manually evaluate the results\\
              \hline
              \textbf{Flow of events} &    \begin{enumerate}
