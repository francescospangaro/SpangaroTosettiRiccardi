...
\begin{itemize}
    ...
    \item 07 January 2024: version 1.1
      \begin{itemize}
            ...
            \item Riformulated scenario 7, in such a way that it adapts better and more 
...
Francesca signs in the platform with her credentials and sees that, in a tournament to which
she is subscribed, a new battle has opened. 
She would like to participate in it, and so decides to form a group with two of her friends to compete in the battle. 
She clicks on the apposite menu and chooses the students she would like to invite to join her group.
After both her friends accept her invite, the group is correctly formed and now, as a group creator,
...
\color{gray}
\noindent//Students subscribed to the CKB platform can have a set of badges\\
\color{blue}
sig
\color{black}
Student\{\\
