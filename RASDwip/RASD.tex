...
\color{black}
\color{blue} pred \color{black} NewGrantedPermit[ t : Tournament, e : Educator, p, pf : Permit ]\{\\
\color{gray}
//Preconditions\\
\color{black}
...
\color{gray}
//Postconditions\\
\-\hspace{1cm}\color{black}pf.battleCreators \color{blue} = \color{black} p.battleCreators \color{blue} + \color{black} e\\
\-\hspace{1cm}pf.tournamentCreator \color{blue} = \color{black} p.tournamentCreator\\
\-\hspace{1cm}pf.tournament \color{blue} = \color{black} p.tournament\\
\noindent
\}\\
\\
\color{gray}
