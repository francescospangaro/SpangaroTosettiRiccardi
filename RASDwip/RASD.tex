...
\begin{enumerate}
    %TODO: Check for typos from here on out
...
\begin{tabular}{|g|c|c|}
    ...
    \hline
    \textbf{Francesco Spangaro}                 & \makecell[l]{                               \\Introduction\\Overall description\\Specific Requirements\\Formal analysis using Alloy\\ \vspace{\baselineskip}} & \makecell[l]{\textit{4h}\\\textit{12h}\\\textit{6h}\\\textit{1h} \vspace{\baselineskip}}\\
    \hline
    \textbf{Luca Tosetti}                       & \makecell[l]{                               \\Introduction\\Overall description\\Specific Requirements\\Formal analysis using Alloy\\ \vspace{\baselineskip}} & \makecell[l]{\textit{7h}\\\textit{5h}\\\textit{20h}\\\textit{1h}}\\
    \hline
    \textbf{Francesco Riccardi}                 & \makecell[l]{                               \\Introduction\\Overall description\\Specific Requirements\\Formal analysis using Alloy\\ \vspace{\baselineskip}} & \makecell[l]{\textit{3h}\\\textit{10h}\\\textit{2h}\\\textit{14h} \vspace{\baselineskip}}\\
    \hline
\end{tabular}
