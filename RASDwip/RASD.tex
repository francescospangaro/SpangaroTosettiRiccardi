...
\begin{description}
    ...
    \item[G2:] \textit{\textbf{Allow Educators to create new battles:}}
          \begin{description}
              \item Educators have the possibility to define new battles within tournaments they crated or in tournaments they have been granted permission to do so. 
              When creating a new battle, Educators have to set different parameters:
                    \begin{itemize}
                        \item upload project description;
                        \item specify the programming language and build tool to utilise, including test cases and build automation scripts;
...
\begin{xltabular}{\textwidth}{ >{\raggedright\arraybackslash}c >{\raggedright\arraybackslash}X }
    ...
    In this context it's used to express the fact that the code needs to be developed multiple times to reach an optimal solution. \\
...
\begin{itemize}
    \item \textbf{\textit{Section 1: Introduction}} \\
          ...
          it's revision history and refereced documents or web pages.
    ...
    \item \textbf{\textit{Section 5: Effor spent}} \\
        This section contains all the information about the time spent by each group member in order to complete this document 
          and it's division by each section of the document.
\end{itemize}
...
and can now access all the CBK platform's features, after loggin in with it's credentials.
...
\subsubsubsection{Educator manually evaluates a battle after it's end}
...
\subsubsubsection{Students visualise theie tournament's results and their badges}
...
\begin{xltabular}{\textwidth}
    ...
    \textbf{Goal ID} & \multicolumn{1}{|g|}{\textbf{Req. ID}} & \multicolumn{1}{|g|}{\textbf{Use case ID}} \\
    \hline
...
\begin{tabular}{|g|c|c|}
    ...
    \textbf{Francesco Spangaro} & \makecell[l]{\\Introduction\\Overall description\\Specific Requirements\\Formal analysis using Alloy\\
     \vspace{\baselineskip}} & \makecell[l]{\textit{4h}\\\textit{12h}\\\textit{7h}\\\textit{2h} \vspace{\baselineskip}}\\
    \hline
    \textbf{Luca Tosetti} & \makecell[l]{\\Introduction\\Overall description\\Specific Requirements\\Formal analysis using Alloy\\
     \vspace{\baselineskip}} & \makecell[l]{\textit{4h}\\\textit{5h}\\\textit{18h}\\\textit{2h}}\\
    \hline
    \textbf{Francesco Riccardi} & \makecell[l]{\\Introduction\\Overall description\\Specific Requirements\\Formal analysis using Alloy\\
     \vspace{\baselineskip}} & \makecell[l]{\textit{4h}\\\textit{10h}\\\textit{2h}\\\textit{12h} \vspace{\baselineskip}}\\
    \hline
\end{tabular}
