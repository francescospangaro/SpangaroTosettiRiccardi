...
\subsection{Product functions}
    ...
    \subsection{Assumptions, dependencies and constraints}
        \begin{itemize}
            ...
            \item[\textbf{D14:}] Students can send an invitation to their group to any other student even if they are not
            subscribed to the same tournament in which they want to partecipate. If it is the case the invited students get
            subscribed automatically to the tournament if they accept the invite.
        \end{itemize}
...
\subsection{Functional requirements}
    \subsubsection{Requirements}
        \begin{itemize}
            ...
            \item[\textbf{R.4}] The CKB platform must not allow a Student or an Educator to register more than once in the system.
            \item[\textbf{R.5}] Educators and Students can access the platform only if they are registered to it.
            \item[\textbf{R.6}] The CKB platform shall not allow Students to create tournaments and/or battles.
            \item[\textbf{R.7}] The CKB platform shall allow to create battles within a tournament only to the creator of
            the tournament or to any other Educator that has the permission to do so, given by the tournament's creator.
                            \item[\textbf{R.8}] The CKB platform must allow Educators to personalize the tournaments that they create.
            \item[\textbf{R.9}] The CKB platform must allow Edcuators to personalize the battles that they create.
            \item[\textbf{R.10}] The CKB platform must allow Educators to define new obtainable badges for each tournament they
            create
            \item[\textbf{R.11}] The CKB platform must allow Educators to manually evaluate the solutions uploaded by the students.
            \item[\textbf{R.12}] The CKB platform must allow Educators to delete or update badges before finalizing tournament creation.
            \item[\textbf{R.13}] The CKB platform must allow Educators to define rules to obtain badges in tournaments created by them.
            \item[\textbf{R.14}] The CKB platform must ensures that badges' characteristics respect some guidelines regarding their
            name, icon format and rules to obtain them.
            \item[\textbf{R.15}] The CKB platform must allow only to Educators to create new tournaments.
            \item[\textbf{R.16}] The CKB platform must ensures that tournaments' characteristics respect some guidelines regarding their
    ...
    \subsubsection{Use case diagrams}
            \begin{itemize}
                \item \underline{\large{\textbf{Student}}}
                    \begin{figure}[H]
                        \centering
                        \includegraphics[scale=0.4]{images/3.2.2_UseCaseDiagrams/CaseDiagramStudent.pdf}
                ...
                \item \underline{\large{\textbf{Educator}}}
                    \begin{figure}[H]
                        \centering
                        \includegraphics[scale=0.4]{images/3.2.2_UseCaseDiagrams/CaseDiagramEducator.pdf}
                ...
                \item \underline{\large{\textbf{GitHub}}}
                    \begin{figure}[H]
                        \centering
                        \includegraphics[scale=0.4]{images/3.2.2_UseCaseDiagrams/CaseDiagramGitHub.pdf}
