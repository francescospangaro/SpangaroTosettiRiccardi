...
\subsubsection{Privacy constraints}
        ...
        Data must be encrypted before it is saved on the database, no data must be accessed by any user other than the data's owner.
        ...
        When a new User, both Educator and Student, wants to register to the platform, the privacy policy must be shown and accepted, before the new user is saved in the database.
        If the privacy policy is not accepted, the user registration procedure is not completed and the new user is not saved in the database, not granting access to the person that was
...
\subsubsection{Availability}
        The platform must be available as much as possible, at least 97\% of the time.
...
\subsubsection{Security}
        ...
        The database guarantees that performed operations are all authorized, and permitted.
