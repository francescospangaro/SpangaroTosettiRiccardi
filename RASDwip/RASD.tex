...
\subsection{User characteristics}
    \subsection{Assumptions, dependencies and constraints}
        \begin{itemize}
            ...
            the invited student is not registered to the tournament, he get automatically
...
\subsection{External interface requirements}
    ...
    \subsubsection{Software Interfaces}
        ...
        \begin{itemize}
            ...
            belonging to the solutions uploaded by the students. In order to do this several
            testing APIs can be used such as Maven. 
        \end{itemize}
            ...
            \begin{enumerate}
                ...
                \item[\textbf{2.}] \textbf{Educator sign up to the platform}
                    ...
                    \begin{xltabular}{\textwidth}
                        ...
                        tournament and want to form a group with other students, in order to later 
                        join a battle within that tournament.\\
                        \hline
                        \textbf{Flow of events} &    \begin{enumerate}
